...
#include "my_robot_interfaces/msg/detail/pose_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::PoseCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::PoseCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::PoseCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PoseCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::PoseCmd *>(
...
static size_t _PoseCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PoseCmd(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PoseCmd__callbacks = {
...
static rosidl_message_type_support_t _PoseCmd__handle = {
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_PoseCmd__handle;
}
